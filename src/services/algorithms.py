...
def input_int_list_to_input_element_list(input: list[int], alphabets: range, variables: range,
                                         numbers: range, left_bracket: int, right_bracket: int,
                                         dot: int, operators: list[int], space: int) -> list[int]:
    ...
    for element in input:
        if element in variables or element in operators + [space, left_bracket, right_bracket, dot]:
            if current:
